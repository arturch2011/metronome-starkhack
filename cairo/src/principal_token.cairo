...
use cairo::erc20::erc20::{IERC20, IERC20Dispatcher, IERC20DispatcherTrait};
...
#[starknet::interface]
trait IPrincipalToken<TContractState> {
    fn multisend(
...
mod PrincipalToken {
    ...
    #[abi(embed_v0)]
    impl PrincipalToken of super::IPrincipalToken<ContractState> {
        fn multisend(
            self: @ContractState,
            token_address: ContractAddress,
